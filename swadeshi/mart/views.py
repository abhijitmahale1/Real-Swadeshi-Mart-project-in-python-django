...
def productView(request, myid):
    ...
    return render(request, 'mart/prodView.html', {'product':product[0]})
...
def checkout(request):
    if request.method=="POST":
        ...
        param_dict = {
                ...
                'WEBSITE': 'WEBSTAGING',
                'CHANNEL_ID': 'WEB',
                'CALLBACK_URL':'http://127.0.0.1:8000/mart/handlerequest/',

        }
        param_dict['CHECKSUMHASH'] = Checksum.generate_checksum(param_dict, MERCHANT_KEY)
        return  render(request, 'mart/paytm.html', {'param_dict': param_dict})
    else:
    ...
    for i in form.keys():
        ...
        if i == 'CHECKSUMHASH':
            ...
            if verify:
                ...
                return render(request, 'mart/paymentstatus.html', {'response': response_dict})
